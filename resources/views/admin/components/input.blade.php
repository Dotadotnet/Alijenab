<div class="">
    <label class="  w-100">
        <span class=" dark:text-white mr-5 text-black">{{$text}} :</span>
        <br>
        <div class="input-admin mt-3 ">
            ...
            <input type="text" maxlength="<?= isset($maxlen) ? $maxlen : "" ?>" name="{{$name}}" placeholder="{{isset($placeholder) ? $placeholder : $text . " ..."}}"  
