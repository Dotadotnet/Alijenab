<nav class="main-nav--bg">
    <div class="container main-nav">
        ...
        <div class="main-nav-end mt-1">
            <button class="  sidebar-toggle transparent-btn flex justify-center items-center" title="Menu" type="button">
            ...
            <div style="margin:0px 10px;" class="nav-user-wrapper flex items-center justify-center">
                <button href="##" class="nav-user-btn dropdown-btn" title="My profile" type="button">
                    <span class="sr-only">My profile</span>
                    <span class="nav-user-img flex items-center ">
                        <picture>
