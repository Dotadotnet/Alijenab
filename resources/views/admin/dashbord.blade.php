...
<div class="grid grid-cols-2 gap-5 px-8 mt-3">
    <label class="w-full">
        <span class=" dark:text-white text-black mr-5">حداقل قیمت خرید :</span>
        <br>
        <div class="input-admin mt-3 ">
            ...
            <input value="{{ $configs[0]->amount }}" style=" width: calc(100% - 70px); " class="currency "
                type="text" name="{{ $configs[0]->key }}" data-type="num" placeholder="1,000,000">
        </div>
    </label>
    <label class="w-full">
        <span class=" dark:text-white text-black mr-5">هزینه ارسال :</span>
        <br>
        <div class="input-admin mt-3 ">
            <div style=" width: 70px; justify-content:space-between;" class="flex items-start flex-row-reverse">
                <div
            ...
            <input value="{{ $configs[1]->amount }}" style=" width: calc(100% - 70px); " class="currency"
