...
@section('header')
    ...
    <meta property="og:title" content="{{ 'تماس با ما | کافه عالی جناب تهران' }}">
    <meta property="og:description"content="{{ "شماره تماس و شبکه های اجتماعی کافه عالیجناب در تهران" }}">
    <meta property="og:image" content="{{ asset('image/cafePhoto3.webp') }}">
...
<section class="max-w-7xl mx-auto px-6 pt-0 sm:pt-14 pb-8 sm:pb-10">
    <div class="rounded-3xl overflow-hidden relative h-48  text-white shadow-2xl">
        <img class="size-full object-cover" src="/image/cafePhoto3.webp" alt="">
        <div class="z-10 flex flex-col justify-center size-full px-6 sm:px-12 bg-black/15  absolute top-0 right-0">
            ...
            <h2 class="text-base sm:text-lg mt-2 sm:mt-4 text-white/90 ">
                برای ارتباط با کافه عالی جناب در تهران، شماره تماس، آدرس و لوکیشن کافه را مشاهده کنید. پاسخگوی سوالات،
                رزرو و هماهنگی‌های شما هستیم .
            </h2>
        </div>
    </div>
</section>
            ...
            <div
                ...
                <div class="space-y-5 pr-2">
                    ...
                    <div class="flex flex-col">
                        ...
                        <a target="_blank" rel="nofollow" href="{{ env('LOCATION_URL_GOOGLE') }}" style="direction: ltr"
                            dir="ltr" class=" mt-2 hover:font-bold leading-8  text-slate-800 dark:text-white">
