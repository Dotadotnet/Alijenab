...
const iconsSvg = document.querySelectorAll('[data-icon]');
...
function reload_button_add_cart_events() {
    ...
    buttons_add_carts.forEach(button_add_cart => {
        ...
        if (icon) {
            ...
            const button_controll = (_a = button.parentElement) === null || _a === void 0 ? void 0 : _a.querySelector("div.box-card-control");
            if (!founded) {
                button_controll === null || button_controll === void 0 ? void 0 : button_controll.classList.add("hidden");
                button.classList.remove("hidden");
            }
            else {
                button_controll === null || button_controll === void 0 ? void 0 : button_controll.classList.remove("hidden");
                button.classList.add("hidden");
            }
            button.onclick = (event) => {
                var _a;
                let button_controll = (_a = button.parentElement) === null || _a === void 0 ? void 0 : _a.querySelector("div.box-card-control");
                let founded = false;
                let data_local = localStorage.getItem('carts_data');
                if (data_local) {
                    let items = JSON.parse(data_local);
                ...
                buttons_add_carts.forEach(button_addcart => {
                    ...
                    if (button_addcart.dataset.id == button.dataset.id) {
                        let button_controll = (_a = button_addcart.parentElement) === null || _a === void 0 ? void 0 : _a.querySelector("div.box-card-control");
                        button_controll === null || button_controll === void 0 ? void 0 : button_controll.classList.remove("hidden");
...
function load_controller_card() {
    const boxs_card_control = document.querySelectorAll('div.box-card-control');
    let cards_local_storage = localStorage.getItem('carts_data');
    if (cards_local_storage) {
...
var blog = document.querySelector('div.amount');
...
if (blog && nav_blog) {
    ...
    const headers_tag = document.querySelectorAll('div.amount h2');
