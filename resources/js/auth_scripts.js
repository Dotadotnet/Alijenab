...
function changeImage() {
    if (image) {
        ...
        if (w > h) {
            image.src = host + 'image/login_image_2.webp';
        }
        else {
            image.src = host + 'image/login_image_1.jpeg';
        }
    }
}
changeImage();
...
if (button_submit_register && info_div && accept_div) {
    ...
    button_submit_register.addEventListener('click', () => { submitForm(); });
}
if (button_login) {
...
const function_onchang = () => {
    ...
    if (hash_string == 'submited') {
        ...
        info_div === null || info_div === void 0 ? void 0 : info_div.classList.remove('hidden');
